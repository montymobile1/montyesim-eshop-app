...
class SupportedShipsResponseModelDto {
  ...
  factory SupportedShipsResponseModelDto.fromJson(Map<String, dynamic> json) {
  ...
  static List<SupportedShipsResponseModelDto> getMockCountries() {
    return <SupportedShipsResponseModelDto>[
      SupportedShipsResponseModelDto(
        country: "Abkhazia",
        countryCode: "GE",
  ...
  SupportedShipsResponseModel toDomain() {
    SupportedShipsResponseModel response = SupportedShipsResponseModel(
      id: id,
      country: country,
      iso3Code: iso3Code,
      zoneName: zoneName,
  ...
  SupportedShipsResponseModelDto fromDomain(SupportedShipsResponseModel? model) {
    SupportedShipsResponseModelDto response = SupportedShipsResponseModelDto(
      id: model?.id,
