...
class SupportedShipsWidget extends StatelessWidget {
  const SupportedShipsWidget({
    required this.label,
    required this.ships,
  ...
  List<Widget> _buildCountryWidgets(
    ...
    int totalCountries = ships.length;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(IterableProperty<SupportedShipsResponseModel>("countries", ships))
