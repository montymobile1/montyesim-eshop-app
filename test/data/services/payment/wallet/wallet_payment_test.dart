...
/// Unit tests for WalletPayment service
/// Tests wallet payment initialization, checkout preparation, and payment processing
void main() {
  group("WalletPayment Tests", () {
    group("Singleton Initialization", () {
      test("singleton instance is created and reused", () {
        // Arrange & Act
        final WalletPayment instance1 = WalletPayment.instance;
        final WalletPayment instance2 = WalletPayment.instance;
      ...
      test("instance is accessible on first call", () {
        // Arrange & Act
        final WalletPayment instance = WalletPayment.instance;

        // Assert
        expect(instance, isNotNull);
        expect(instance, isA<WalletPayment>());
      });
    });
    ...
    group("Async Method - prepareCheckout", () {
      test("prepareCheckout can be called without throwing", () async {
        // Arrange
        final WalletPayment service = WalletPayment.instance;
    ...
    group("Async Method - processOrderPayment", () {
      ...
      test("processOrderPayment returns completed result", () async {
        // Arrange
        final WalletPayment service = WalletPayment.instance;
        final ProcessOrderPaymentParams params = ProcessOrderPaymentParams(
    ...
    group("State Consistency", () {
      test("WalletPayment instance is consistent across multiple accesses", () {
        // Arrange & Act
        final WalletPayment instance1 = WalletPayment.instance;
        final WalletPayment instance2 = WalletPayment.instance;
        final WalletPayment instance3 = WalletPayment.instance;
